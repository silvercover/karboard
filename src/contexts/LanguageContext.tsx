...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'project.no.invitations': 'No invitations sent yet',
    'project.delete.confirm.title': 'Delete Project',
    'project.delete.confirm.message': 'Are you sure you want to delete this project? This action cannot be undone.',
    'project.delete.confirm.yes': 'Delete',
    'project.delete.confirm.no': 'Cancel',
    'board.title': 'My Board',
    'list.add': 'Add List',
    'list.edit': 'Edit List',
    'list.delete': 'Delete List',
    'list.delete.confirm.title': 'Delete List',
    'list.delete.confirm.message': 'Are you sure you want to delete this list? All cards in this list will be permanently deleted.',
    'list.delete.confirm.yes': 'Delete List',
    'list.delete.confirm.no': 'Cancel',
  ...
  fa: {
    ...
    'project.general': 'عمومی',
    'project.invitations': 'دعوت‌نامه‌ها',
    'project.no.invitations': 'هنوز دعوت‌نامه‌ای ارسال نشده',
    'project.delete.confirm.title': 'حذف پروژه',
    'project.delete.confirm.message': 'آیا مطمئن هستید که می‌خواهید این پروژه را حذف کنید؟ این عمل قابل بازگشت نیست.',
    'project.delete.confirm.yes': 'حذف',
    'project.delete.confirm.no': 'لغو',
    'board.title': 'تخته من',
    'list.add': 'افزودن لیست',
    'list.edit': 'ویرایش لیست',
    'list.delete': 'حذف لیست',
    'list.delete.confirm.title': 'حذف لیست',
    'list.delete.confirm.message': 'آیا مطمئن هستید که می‌خواهید این لیست را حذف کنید؟ تمام کارت‌های این لیست به طور دائم حذف خواهند شد.',
    'list.delete.confirm.yes': 'حذف لیست',
    'list.delete.confirm.no': 'لغو',
    ...
    'invitation.pending': 'در انتظار',
    'invitation.accepted': 'پذیرفته شده',
    'invitation.rejected': 'رد شده'
  }
};
